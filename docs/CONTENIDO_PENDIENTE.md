...
| Áreas del derecho: explicación de cada página `/servicios/<slug>` (civil, laboral, familia, comercial, penal, conciliación) | `services.json` → `details`                                                                                       | Redactadas por Claude (`provisional`). Fotos en `public/images/areas/` (recortes de `Servicios_Juridicos.png`, reemplazables con el mismo nombre)                                                                                                                                                                                                        |
| Artículos de Actualidad Jurídica (diseño de la maqueta del 26-sep-2026)                                                     | `articles/<slug>.json`                                                                                            | 7 artículos `provisional`. Con texto explicativo: tutela, terminación laboral, comparendos antiguos y reporte negativo. **Sin texto aún ("contenido en preparación")**: cambios de la semana, cambios pensionales y decisiones de las altas cortes. El de derecho de petición quedó como borrador (`"published": false`). Revisar todo antes de publicar |
| Fotos de Actualidad Jurídica                                                                                                | `public/images/actualidad/`                                                                                       | Recortes de la maqueta (baja resolución, ampliados). Reemplazar por las imágenes originales en alta resolución con el mismo nombre de archivo                                                                                                                                                                                                            |
...
| Fotos de los 6 servicios                                                                                                    | `FRONTEND/public/images/servicios-frecuentes/<slug>.webp` (ruta en `image` de cada `landings/<slug>.json`)        | Recortes de la maqueta `SIGUIENTE_DESPUES_DE_INCIO.png` (resolución media). Reemplazar por las fotos originales con el mismo nombre de archivo (ver sección 3)                                                                                                                                                                                           |
